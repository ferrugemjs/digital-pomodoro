...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(6)], __WEBPACK_AMD_DEFINE_RESULT__ = function (require, exports, platform_1) {
    "use strict";
    ...
    if (true) {
        __webpack_require__.e/* require */(0).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [(__webpack_require__(4)("./" + app_url + templateExtension))]; (function (_mod_init_app) {
            platform_1.default
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(0), __webpack_require__(1), __webpack_require__(5)], __WEBPACK_AMD_DEFINE_RESULT__ = function (require, exports, _IDOM, nodes_watched_1, nodes_action_1) {
    "use strict";
    ...
    var ComponentFactory = (function () {
        ...
        ComponentFactory.prototype.compose = function (path, target, host_vars, static_vars, contentfn) {
            ...
            if (true) {
                __webpack_require__.e/* require */(0/* duplicate */).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [(__webpack_require__(4)("./" + path + this.config.templateExtension))]; (handlerLoad.bind(this).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
            }
            else {
